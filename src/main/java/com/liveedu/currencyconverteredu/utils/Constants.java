...
//import com.epam.beamery.model.Application;
//import com.epam.beamery.model.Attachment;
//import com.epam.beamery.model.Candidate;
//import com.epam.beamery.model.Note;
//import com.epam.beamery.model.Vacancy;
...
//    TypeReference<List<Candidate>> LIST_CANDIDATE_TYPE_REFERENCE = new TypeReference<>() {
//    };
//    TypeReference<List<Vacancy>> LIST_VACANCY_TYPE_REFERENCE = new TypeReference<>() {
//    };
//    TypeReference<List<Note>> LIST_NOTE_TYPE_REFERENCE = new TypeReference<>() {
//    };
//    TypeReference<List<Application>> LIST_APPLICATION_TYPE_REFERENCE = new TypeReference<>() {
//    };
//    TypeReference<List<Attachment>> LIST_ATTACHMENT_TYPE_REFERENCE = new TypeReference<>() {
//    };
